    ...
    if (restart > 0) {
        ...
        if (do_1D) {
            ...
            ReadCheckPoint3D(step_start, time, statsCount, geom, domain, cu, cuMeans, cuVars, prim,
                             primMeans, primVars, cumom, cumomMeans, cumomVars, 
                             vel, velMeans, velVars, coVars, surfcov, surfcovMeans, surfcovVars, surfcovcoVars, spatialCross3D, ncross, ba, dmap);
        }
        ...
        if (plot_int > 0) {
            WritePlotFileStag(0, 0.0, geom, cu, cuMeans, cuVars, cumom, cumomMeans, cumomVars, 
                          prim, primMeans, primVars, vel, velMeans, velVars, coVars, surfcov, surfcovMeans, surfcovVars, surfcovcoVars, eta, kappa);
        ...
        if (chk_int > 0 && step > 0 && step%chk_int == 0)
        {
            if (do_1D) {
                ...
                WriteCheckPoint3D(step, time, statsCount, geom, cu, cuMeans, cuVars, prim,
                                  primMeans, primVars, cumom, cumomMeans, cumomVars, 
                                  vel, velMeans, velVars, coVars, surfcov, surfcovMeans, surfcovVars, surfcovcoVars, spatialCross3D, ncross);
            }
        }
