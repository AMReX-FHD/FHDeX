                 ...
                 const amrex::Geometry geom, const amrex::Real* dxp, const amrex::Real dt)
{
    ...
    calculateFluxStag(cu, momStag, prim, velStag, eta, zeta, kappa, chi, D, flux, stochFlux, cornx, corny, cornz,
...
//
    ...
    conservedToPrimitiveStag(prim, velStag, cup, mompStag);
    ...
    calculateFluxStag(cup, mompStag, prim, velStag, eta, zeta, kappa, chi, D, flux, stochFlux, cornx, corny, cornz,
                  visccorn, rancorn, geom, stoch_weights, dxp, dt);
...
//
    ...
    conservedToPrimitiveStag(prim, velStag, cup2, momp2Stag);
    ...
    calculateFluxStag(cup2, momp2Stag, prim, velStag, eta, zeta, kappa, chi, D, flux, stochFlux, cornx, corny, cornz,
                  visccorn, rancorn, geom, stoch_weights, dxp, dt);
