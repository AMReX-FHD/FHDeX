...
contains
  ...
  subroutine initialize_common_namespace(prob_lo_in, prob_hi_in, n_cells_in, &
                                         ...
                                         particle_grid_refine_in, es_grid_refine_in, diff_in, fluid_tog_in, es_tog_in, drag_tog_in, move_tog_in, rfd_tog_in, dry_move_tog_in, sr_tog_in, crange_in, images_in, eamp_in, efreq_in, ephase_in) &
