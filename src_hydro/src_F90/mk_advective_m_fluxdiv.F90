...
contains
    ...
    subroutine mk_advective_m_fluxdiv(lo,hi, &
      ...
      double precision :: mx_fluxx  (lo(1):hi(1)+2,lo(2):hi(2)  )
      double precision :: mx_fluxy  (lo(1):hi(1)+1,lo(2):hi(2)+1)

      double precision :: my_fluxx(lo(1):hi(1)+1,lo(2):hi(2)+1)
      double precision :: my_fluxy(lo(1):hi(1)  ,lo(2):hi(2)+2)
