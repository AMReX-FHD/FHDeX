...
if len(sys.argv) == 2 and sys.argv[1] == "rate":
    ...
    print("event       4 siteA vac   %e spec1 beta -0.5" % (kads1/p1))
    print("event       4 siteB vac   %e spec1 beta -0.5" % (kads2/p1))
    print("event       6 siteA siteA vac   vac   %e spec2 spec2 spec2 beta -0.5 #half" % ((kads3/2)/p2))
    print("event       6 siteA siteB vac   vac   %e spec2 spec2 spec2 beta -0.5" % (kads4/p2))
    print("event       6 siteB siteA vac   vac   %e spec2 spec2 spec2 beta -0.5" % (kads4/p2))
    print("event       6 siteB siteB vac   vac   %e spec2 spec2 spec2 beta -0.5 #half" % ((kads5/2)/p2))
print("\n# Desorption")
