...
lat_const = 2.8e-8  # lattice constant of Pt(111)
Nucx = 300          # number of unit cells in dx
Nucy = 150          # number of unit cells in dy
Ntot = 2*Nucx*Nucy  # total number of sites per dx*dy (2 sites per unit cell)

dx = Nucx*lat_const
dy = Nucy*lat_const*math.sqrt(3)
dz = dx
dv = dx*dy*dz
