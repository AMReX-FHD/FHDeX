...
//domainLo x plane
    ...
    paramPlaneList[0].uTop = domainHi[1];
    paramPlaneList[0].vTop = domainHi[2];
...
//domianHi x plane
    ...
    paramPlaneList[1].uTop = domainHi[1];
    paramPlaneList[1].vTop = domainHi[2];
...
//domainLo y plane
    ...
    paramPlaneList[2].uTop = domainHi[0];
    paramPlaneList[2].vTop = domainHi[2];
...
//domianHi y plane
    ...
    paramPlaneList[3].uTop = domainHi[0];
    paramPlaneList[3].vTop = domainHi[2];
...
//domainLo z plane
    ...
    paramPlaneList[4].uTop = domainHi[0];
    paramPlaneList[4].vTop = domainHi[1];
...
//domianHi z plane
    ...
    paramPlaneList[5].uTop = domainHi[0];
    paramPlaneList[5].vTop = domainHi[1];
...
//Membrane
  /*  paramPlaneList[6].x0 = 25e-6;
    paramPlaneList[6].y0 = domainLo[1];
    paramPlaneList[6].z0 = domainLo[2];

    paramPlaneList[6].ux = 0;
    paramPlaneList[6].uy = 1;
    paramPlaneList[6].uz = 0;

    paramPlaneList[6].vx = 0;
    paramPlaneList[6].vy = 0;
    paramPlaneList[6].vz = 1;

    paramPlaneList[6].uTop = domainHi[1];
    paramPlaneList[6].vTop = domainHi[2];

    paramPlaneList[6].lnx = -1;
    paramPlaneList[6].lny = 0;
    paramPlaneList[6].lnz = 0;
    
    paramPlaneList[6].rnx = 1;
    paramPlaneList[6].rny = 0;
    paramPlaneList[6].rnz = 0;

    paramPlaneList[6].porosityLeft = 0.5;
    paramPlaneList[6].specularityLeft = 1;
    paramPlaneList[6].temperatureLeft = 273;
    paramPlaneList[6].momentumConsLeft = 1;

    paramPlaneList[6].porosityRight = 0.5;
    paramPlaneList[6].specularityRight = 1;
    paramPlaneList[6].temperatureRight = 273;
    paramPlaneList[6].momentumConsRight = 1;

    paramPlaneList[6].periodicity = 0;
    paramPlaneList[6].boundary = 0;
        
    theta = getTheta(paramPlaneList[6].lnx, paramPlaneList[6].lny, paramPlaneList[6].lnz);
    phi   = getPhi(paramPlaneList[6].lnx, paramPlaneList[6].lny, paramPlaneList[6].lnz);

    paramPlaneList[6].cosThetaLeft = cos(theta);
    paramPlaneList[6].sinThetaLeft = sin(theta);
    paramPlaneList[6].cosPhiLeft = cos(phi);
    paramPlaneList[6].sinPhiLeft = sin(phi);

    theta = getTheta(paramPlaneList[6].rnx, paramPlaneList[6].rny, paramPlaneList[6].rnz);
    phi   = getPhi(paramPlaneList[6].rnx, paramPlaneList[6].rny, paramPlaneList[6].rnz);

    paramPlaneList[6].cosThetaRight = cos(theta);
    paramPlaneList[6].sinThetaRight = sin(theta);
    paramPlaneList[6].cosPhiRight = cos(phi);
    paramPlaneList[6].sinPhiRight = sin(phi);

    paramPlaneList[6].fxLeftAv = 0;
    paramPlaneList[6].fyLeftAv = 0;
    paramPlaneList[6].fzLeftAv = 0;

    paramPlaneList[6].fxRightAv = 0;
    paramPlaneList[6].fyRightAv = 0;
    paramPlaneList[6].fzRightAv = 0;*/
...
//domainLo x
    ...
    theta = getTheta(paramPlaneList[0].lnx, paramPlaneList[0].lny, 0);

    paramPlaneList[0].cosThetaLeft = cos(theta);
    paramPlaneList[0].sinThetaLeft = sin(theta);

    theta = getTheta(paramPlaneList[0].rnx, paramPlaneList[0].rny, 0);
...
//domianHi x plane
    ...
    theta = getTheta(paramPlaneList[1].lnx, paramPlaneList[1].lny, 0);

    paramPlaneList[1].cosThetaLeft = cos(theta);
    paramPlaneList[1].sinThetaLeft = sin(theta);

    theta = getTheta(paramPlaneList[1].rnx, paramPlaneList[1].rny, 0);
...
//domainLo y plane
    ...
    paramPlaneList[2].porosityLeft = 1;
    paramPlaneList[2].specularityLeft = 1;
    paramPlaneList[2].temperatureLeft = 273;
    paramPlaneList[2].momentumConsLeft = 1;

    paramPlaneList[2].porosityRight = 1;
    paramPlaneList[2].specularityRight = 1;
    paramPlaneList[2].temperatureRight = 273;
    paramPlaneList[2].momentumConsRight = 1;

    paramPlaneList[2].periodicity = 1;
    paramPlaneList[2].boundary = 3;

    theta = getTheta(paramPlaneList[2].lnx, paramPlaneList[2].lny, 0);

    paramPlaneList[2].cosThetaLeft = cos(theta);
    paramPlaneList[2].sinThetaLeft = sin(theta);

    theta = getTheta(paramPlaneList[2].rnx, paramPlaneList[2].rny, 0);
...
//domianHi y plane
    ...
    paramPlaneList[3].porosityLeft = 1;
    paramPlaneList[3].specularityLeft = 1;
    paramPlaneList[3].temperatureLeft = 273;
    paramPlaneList[3].momentumConsLeft = 1;

    paramPlaneList[3].porosityRight = 1;
    paramPlaneList[3].specularityRight = 1;
    paramPlaneList[3].temperatureRight = 273;
    paramPlaneList[3].momentumConsRight = 1;

    paramPlaneList[3].periodicity = 1;
    paramPlaneList[3].boundary = 4;

    theta = getTheta(paramPlaneList[3].lnx, paramPlaneList[3].lny, 0);

    paramPlaneList[3].cosThetaLeft = cos(theta);
    paramPlaneList[3].sinThetaLeft = sin(theta);

    theta = getTheta(paramPlaneList[3].rnx, paramPlaneList[3].rny, 0);
...
//Membrane
    paramPlaneList[4].x0 = 3.753e-7;
    paramPlaneList[4].y0 = domainLo[1];

    paramPlaneList[4].ux = 0;
    paramPlaneList[4].uy = 1;

    paramPlaneList[4].uTop = domainHi[1];

    paramPlaneList[4].lnx = -1;
    paramPlaneList[4].lny = 0;
    
    paramPlaneList[4].rnx = 1;
    paramPlaneList[4].rny = 0;

    paramPlaneList[4].porosityLeft = 0.2;
    paramPlaneList[4].specularityLeft = 1;
    paramPlaneList[4].temperatureLeft = 273;
    paramPlaneList[4].momentumConsLeft = 1;

    paramPlaneList[4].porosityRight = 0.2;
    paramPlaneList[4].specularityRight = 1;
    paramPlaneList[4].temperatureRight = 273;
    paramPlaneList[4].momentumConsRight = 1;

    paramPlaneList[4].periodicity = 0;
    paramPlaneList[4].boundary = 0;
        
    theta = getTheta(paramPlaneList[4].lnx, paramPlaneList[4].lny, 0);

    paramPlaneList[4].cosThetaLeft = cos(theta);
    paramPlaneList[4].sinThetaLeft = sin(theta);

    theta = getTheta(paramPlaneList[4].rnx, paramPlaneList[6].rny, 0);
