...
void writePlotFile(const MultiFab& mfcuInst,
    ...
    const MultiFab& mfrhotimecross,
    const MultiFab& mfutimecross,
    const MultiFab& mfKtimecross,
    const MultiFab& mfvmom,
    ...
    int step)
{
    ...
    */
    ...
    if(plot_time>0)
    {
      ...
      WriteHorizontalAverage(mfutimecross,0,0,ntime,step,geom,file_prefix_utime);
    ...
    particles.WritePlotFile(pltpart, "particles",write_real_comp, write_int_comp, real_comp_names, int_comp_names);
}
