...
*/
    ...
    for (int istep=step; istep<=max_step; ++istep) {
        ...
        if(istep == 2)
        {
            particles.SetPosition(0, 1, prob_hi[0]/2.0 - 2*dxp[0], 4*dxp[1], prob_hi[2]/4.0);
            particles.SetPosition(1, 1, prob_hi[0]/2.0 + 2*dxp[0], 4*dxp[1], prob_hi[2]/4.0);
        }
        if(istep == 3)
        {
            particles.SetPosition(0, 1, prob_hi[0]/2.0 - 2*dxp[0], 8*dxp[1], prob_hi[2]/4.0);
            particles.SetPosition(1, 1, prob_hi[0]/2.0 + 2*dxp[0], 8*dxp[1], prob_hi[2]/4.0);
        }
        if(istep == 4)
        {
            particles.SetPosition(0, 1, prob_hi[0]/2.0 - 2*dxp[0], 2.8*dxp[1], prob_hi[2]/4.0);
            particles.SetPosition(1, 1, prob_hi[0]/2.0 + 2*dxp[0], 2.8*dxp[1], prob_hi[2]/4.0);
        }
        if(istep == 5)
        {
            particles.SetPosition(0, 1, prob_hi[0]/2.0 - 2*dxp[0], 2*dxp[1], prob_hi[2]/4.0);
            particles.SetPosition(1, 1, prob_hi[0]/2.0 + 2*dxp[0], 2*dxp[1], prob_hi[2]/4.0);
        }
        if(istep == 6)
        {
            particles.SetPosition(0, 1, prob_lo[0] - 2*dxp[0], 2*dxp[1], prob_hi[2]/4.0);
            particles.SetPosition(1, 1, prob_hi[0] + 2*dxp[0], 2*dxp[1], prob_hi[2]/4.0);
        }
        if(istep == 7)
        {
            particles.SetPosition(0, 1, prob_lo[0] - 2*dxp[0], 2.8*dxp[1], prob_hi[2]/4.0);
            particles.SetPosition(1, 1, prob_hi[0] + 2*dxp[0], 2.8*dxp[1], prob_hi[2]/4.0);
        }
