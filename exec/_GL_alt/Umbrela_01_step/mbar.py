...
for y in range (0,N):
        print('data'+str((y)*phi_increment+phi_initial)) #print out for verifying correct data file names have been chosen
        files.append('data'+str((y)*phi_increment+phi_initial)) #add names of files to be read to array
