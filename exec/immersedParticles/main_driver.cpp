...
void main_driver(const char* argv)
{
    ...
    for(step=1;step<=max_step;++step)
    {
       ...
       //Particles
        ...
        particles.EvaluateStats(particleInstant, particleMeans, particleVars, delHolder1, delHolder2, delHolder3, delHolder4, delHolder5, delHolder6, particleMembraneFlux, cellVols, activeParticle, dt,statsCount);
