...
echo "mpirun -np 16 $exec1 -var SEED 100 -screen none < $SPKSCR : -np 8 $exec2 $FHDSCR > log.fhd &"
mpirun -np 16 $exec1 -var SEED 100 -screen none < $SPKSCR : -np 8 $exec2 $FHDSCR > log.fhd &
