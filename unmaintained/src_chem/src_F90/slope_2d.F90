module slope_module_2d
  ...
  public :: slopex_2d, slopey_2d

contains

  subroutine slopex_2d(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  subroutine slopey_doit_2d(lo, hi, &
                         q, qlo, qhi, &
                         dq, dqlo, dqhi, &
  ...
  end subroutine slopey_doit_2d

end module slope_module_2d
