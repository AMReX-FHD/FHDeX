module slope_module_3d
  ...
  public :: slopex_3d, slopey_3d, slopez_3d

contains

  subroutine slopex_3d(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  end subroutine slopex_3d


  subroutine slopey_3d(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  end subroutine slopey_3d

  subroutine slopey_doit_3d(lo, hi, &
                         q, qlo, qhi, &
                         dq, dqlo, dqhi, &
  ...
  end subroutine slopey_doit_3d


  subroutine slopez_3d(lo, hi, &
                    q, qlo, qhi, &
                    dq, dqlo, dqhi)
  ...
  subroutine slopez_doit_3d(lo, hi, &
                         q, qlo, qhi, &
                         dq, dqlo, dqhi, &
                         dsgn, dlim, df, dcen, ddlo, ddhi)
  ...
  end subroutine slopez_doit_3d

end module slope_module_3d
